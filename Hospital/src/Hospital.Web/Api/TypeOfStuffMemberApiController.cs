...
public class TypeOfStuffMemberApiController : BaseApiController
{
  public TypeOfStuffMemberApiController(IMediator mediator, IMapper mapper) : base(mediator, mapper)
  {
