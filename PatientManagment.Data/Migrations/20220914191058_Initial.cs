    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StuffMember", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StuffMember_Department_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Department",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StuffMember_TypesOfStuffMember_TypeOfStuffMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StuffMember_DepartmentId",
                table: "StuffMember",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_StuffMember_TypeOfStuffMemberId",
                table: "StuffMember",
